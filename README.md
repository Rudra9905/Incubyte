...
Below is the summary of the latest code coverage report generated by JaCoCo for the backend services:

| Metric | Covered | Missed | Total | Coverage % | Status |
|--------|---------|--------|-------|------------|--------|
| **Instruction** | 1,499 | 256 | 1,755 | 85.41% | 🟢 Excellent |
| **Branch** | 62 | 42 | 104 | 59.62% | 🟡 Warning |
| **Line** | 412 | 87 | 499 | 82.57% | 🟢 Excellent (Passed >80% Gate) |
| **Complexity** | 169 | 57 | 226 | 74.78% | 🟢 Safe |
| **Method** | 147 | 27 | 174 | 84.48% | 🟢 Excellent |
| **Class** | 29 | 0 | 29 | 100.00% | 🟢 Excellent |

*(To run tests yourself and generate the coverage report, use `mvn test` in the Backend folder and `npm run test` in the Frontend folder. The coverage report will be generated at `Backend/target/site/jacoco/index.html`).*
